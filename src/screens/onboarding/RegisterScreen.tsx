                        ...
                        render={({ field: { onChange, onBlur, value } }) => (
                            <View style={styles.fieldGroup}>
                                ...
                                <Text style={styles.fieldHint}>
                                    Usamos isso para confirmar sua faculdade. Sem spam, promessa.
                                </Text>
                                {errors.email && (
                    ...
                    <Controller
                        ...
                        render={({ field: { onChange, onBlur, value } }) => (
                            <View style={styles.fieldGroup}>
                                ...
                                <View style={[styles.inputWrap, { borderColor: getBorderColor("university") }]}>
                                    <TextInput
                                        style={styles.input}
                                        value={value}
                                        onChangeText={onChange}
                                ...
                                {errors.university && (
                                    <Text style={styles.fieldError}>{errors.university.message}</Text>
                                )}
                            </View>
                        )}
                    />
                    ...
                    <Controller
                        ...
                        render={({ field: { onChange, onBlur, value } }) => (
                            <View style={styles.fieldGroup}>
                                ...
                                <View style={[styles.inputWrap, { borderColor: getBorderColor("course") }]}>
                                    <TextInput
                                        style={styles.input}
                                        value={value}
                                        onChangeText={onChange}
                                        ...
                                        autoCapitalize="words"
                                        autoCorrect={false}
                                        placeholder="Design Industrial"
                                        placeholderTextColor={Colors.ink3}
                                        editable={!loading}
                                    />
                                </View>
                                {errors.course && (
                                    <Text style={styles.fieldError}>{errors.course.message}</Text>
                                )}
                            </View>
                        )}
                    />
